...
//=========  (Wed Feb  3 21:18:28 2021) by ROOT version 6.22/06
...
// ------------>Primitives in pad: cc_1
   ...
   TH2F *hdEtotE = new TH2F("hdEtotE","exit: Scale 93",1000,0,300,1000,0,500);
...
// ------------>Primitives in pad: cc_2
   ...
   TH1F *htotEg__1 = new TH1F("htotEg__1","exit: Scale 93",1000,0,300);
   ...
   TH1F *htotE__2 = new TH1F("htotE__2","exit: Scale 93",1000,0,300);
